...
| [007 — Local cutaway for occluded actors](007-local-actor-cutaway.md) | P2 | Done, committed locally on top of `5c53acd`; not pushed or PRed | See the plan's Evidence section, and `game/progress.md` |
