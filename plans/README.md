...
| [006 — Macro-scale paving variation](006-macro-paving-variation.md) | P2 | Done, implemented on top of 004/005, not committed to a PR branch yet | See the plan's Evidence section, and `game/progress.md` |
