...
| [012 — Figures as part lists, and a bench that shows them in seconds](012-figure-modules-and-bench.md) | P2 | Done, all stages (0/A/B/C), on worktree branch `feat/figure-bench` from `6fb6644` — not committed, per the plan | See `game/progress.md` (plan 012 entry: Stage 0 noise floor, per-stage gates, the bake-ordering method, bench timings and final full-suite result) |
