...
| [013 — Bring the knight closer to the turnaround sheet](013-knight-turnaround.md) | P2 | Done on `main` working tree 2026-09-23, not committed. Helm stays pale steel (head-over-shoulders guard), no gold on the lames, no back diamond on the cape | See `game/progress.md` (plan 013 entry: counters, per-facing separation on both renderers, gates, compare sheet) |
